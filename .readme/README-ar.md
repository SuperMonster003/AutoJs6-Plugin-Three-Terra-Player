...
يوفر الاصدار 1.4.0 اجراءات v12 للقراءة فقط ووصولا محدودا للشقائق واختيار مستندات مستقلا ومداخل Android للصوت وWMA. ومن دون Host Session اختيارية يشغل الملف المحدد فقط.
