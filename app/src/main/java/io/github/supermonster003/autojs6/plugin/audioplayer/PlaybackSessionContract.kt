...
internal object PlaybackSessionContract {
    ...
    private fun command(name: String) = SessionCommand(
        "io.github.supermonster003.autojs6.plugin.audioplayer.command.$name",
        Bundle.EMPTY,
    )

    private const val EXTRA_SLEEP_MODE =
        "io.github.supermonster003.autojs6.plugin.audioplayer.state.SLEEP_MODE"
    private const val EXTRA_SLEEP_DEADLINE =
        "io.github.supermonster003.autojs6.plugin.audioplayer.state.SLEEP_DEADLINE"
    private const val EXTRA_AB_START =
        "io.github.supermonster003.autojs6.plugin.audioplayer.state.AB_START"
    private const val EXTRA_AB_END =
        "io.github.supermonster003.autojs6.plugin.audioplayer.state.AB_END"
