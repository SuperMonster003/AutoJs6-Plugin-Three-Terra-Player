...
import io.github.supermonster003.autojs6.plugin.threeterraplayer.policy.AudioUriForwardRequest
import io.github.supermonster003.autojs6.plugin.threeterraplayer.policy.AudioUriForwardingPolicy
...
internal object AudioPlaybackContract {
    ...
    const val ACTION_START_PLAYBACK =
        "io.github.supermonster003.autojs6.plugin.threeterraplayer.action.START_PLAYBACK"

    const val MEDIA_EXTRA_SOURCE_URI =
        "io.github.supermonster003.autojs6.plugin.threeterraplayer.media.SOURCE_URI"
    const val MEDIA_EXTRA_SOURCE_MIME_TYPE =
        "io.github.supermonster003.autojs6.plugin.threeterraplayer.media.SOURCE_MIME_TYPE"
    const val MEDIA_EXTRA_SOURCE_DISPLAY_NAME =
        "io.github.supermonster003.autojs6.plugin.threeterraplayer.media.SOURCE_DISPLAY_NAME"

    const val HOST_SOURCE_SCHEME = "autojs6-explorer"

    private const val EXTRA_TRACK_MIME_TYPES =
        "io.github.supermonster003.autojs6.plugin.threeterraplayer.extra.TRACK_MIME_TYPES"
