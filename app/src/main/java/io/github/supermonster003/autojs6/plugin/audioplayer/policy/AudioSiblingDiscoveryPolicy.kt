...
import io.github.supermonster003.autojs6.plugin.audioplayer.AudioPlayerPlugin
...
internal object AudioSiblingDiscoveryPolicy {
    ...
    fun discover(
        ...
        require(extension(selectedDisplayName) in AudioPlayerPlugin.EXTENSIONS)
        val tracksByName = siblings.asSequence()
            ...
            .filter { extension(it.displayName) in AudioPlayerPlugin.EXTENSIONS }
